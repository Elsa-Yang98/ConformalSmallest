---
title: "Example_Tuning-free_ridge_regression"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Example_Tuning-free_ridge_regression}
...
df.cov <- data.frame(dim,apply(cov.param_linear_fm_t3,2,mean),apply(cov.naive_linear_fm_t3,2,mean),apply(cov.vfcp_linear_fm_t3,2,mean),apply(cov.star_linear_fm_t3,2,mean),apply(cov.cv5_linear_fm_t3,2,mean), apply(cov.efcp_linear_fm_t3,2,mean))

df.len <- data.frame(dim,apply(len.param_linear_fm_t3,2,mean),apply(len.naive_linear_fm_t3,2,mean),apply(len.vfcp_linear_fm_t3,2,mean),apply(len.star_linear_fm_t3,2,mean),apply(len.cv5_linear_fm_t3,2,mean), apply(len.efcp_linear_fm_t3,2,mean))

save(dim,cov.param_linear_fm_t3, cov.naive_linear_fm_t3, cov.vfcp_linear_fm_t3, cov.star_linear_fm_t3, cov.cv5_linear_fm_t3, cov.efcp_linear_fm_t3, file = "ridge_linear_cov100_t3.RData" )
save(dim,len.param_linear_fm_t3, len.naive_linear_fm_t3, len.vfcp_linear_fm_t3, len.star_linear_fm_t3, len.cv5_linear_fm_t3, len.efcp_linear_fm_t3, file = "ridge_linear_len100_t3.RData" )
```
...
df.lambda <- data.frame(lambda.efcp, lambda.vfcp, lambda.star, lambda.cv5)


save(dim,cov.param_linear_fm_t5, cov.naive_linear_fm_t5, cov.vfcp_linear_fm_t5, cov.star_linear_fm_t5, cov.cv5_linear_fm_t5, cov.efcp_linear_fm_t5, file = "ridge_linear_cov100_t5.RData" )
save(dim,len.param_linear_fm_t5, len.naive_linear_fm_t5, len.vfcp_linear_fm_t5, len.star_linear_fm_t5, len.cv5_linear_fm_t5, len.efcp_linear_fm_t5, file = "ridge_linear_len100_t5.RData" )
```
